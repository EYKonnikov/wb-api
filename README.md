...
- PHP 8.2
- Laravel 11
- PostgreSQL (Neon-backed, Replit) — используется вместо MySQL, т.к. Replit предоставляет PostgreSQL как встроенную БД. Laravel полностью поддерживает оба драйвера без изменения логики.
...
|----------|----------|
| **Тип БД** | PostgreSQL |
| **Хост** | Внутренний хост Replit (доступен через DATABASE_URL в env) |
| **Порт** | 5432 |
| **Пользователь** | postgres |
| **База данных** | heliumdb |
| **DATABASE_URL** | `postgresql://postgres:password@helium/heliumdb?sslmode=disable` |

> БД доступна внутри среды Replit. Для внешнего доступа используйте Replit Shell или Database tools.
